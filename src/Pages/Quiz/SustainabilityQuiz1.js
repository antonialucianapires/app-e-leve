...
function quiz1({navigation}) {
    const [data, setData] = useState({ quiz2: [] });
    useEffect(() => {
    ...
    [answerD,setAnswerD] = useState(Boolean)
     ...
     return (
        <View style={styles.container}>
            <Text style={styles.question}>{data.quiz2.map(item => (item.question))}</Text>            
            <CheckBox
                title={data.quiz2.map(item => (item.options[0]))}
            ...
            />
            <CheckBox
                title={data.quiz2.map(item => (item.options[1]))}
                containerStyle={styles.checkBox}
                textStyle={styles.textCheckBox}
                checkedColor='#FFFFFF'
                uncheckedColor='#FFFFFF'
            ...
            />
            <CheckBox
                title={data.quiz2.map(item => (item.options[2]))}
                containerStyle={styles.checkBox}
                textStyle={styles.textCheckBox}
                checkedColor='#FFFFFF'
                uncheckedColor='#FFFFFF'
            ...
            />
            <CheckBox
                title={data.quiz2.map(item => (item.options[3]))}
                containerStyle={styles.checkBox}
                textStyle={styles.textCheckBox}
                checkedColor='#FFFFFF'
                uncheckedColor='#FFFFFF'
